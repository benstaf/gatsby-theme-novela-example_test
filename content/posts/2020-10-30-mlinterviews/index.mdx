---
title: Job interviews in data science - my experience copy-pasting solutions
author: Mostapha Benhenda
date: 2020-10-30
hero: ./images/copypasting.jpg
excerpt: Talent shortage is a common myth about data science. Now I have more facts
---

Talent war and talent shortage are common myths about tech in general, and data science in particular. In a [previous blog post](https://medium.com/the-ai-lab/talent-shortage-in-ai-is-a-myth-reply-to-cedric-villani-c592047a9a1b), I explained why I thought the problem was rather about Human Resources, an inability to design appropriate recruitment processes.

Now I have more facts to back this claim. I recently decided to apply for data scientist positions, in order to benefit from the new remote work opportunities opened by the pandemic, and to make some money.

In this blog post, I am going to share some details about what really happens in these interviews, from my personal perspective as a [copy-paste data scientist](https://www.quora.com/I-am-a-copy-and-paste-developer-how-do-I-become-a-real-software-developer), who acquired the habit of asking Google/GitHub/Stackoverflow before starting to code.

![](https://cdn-images-1.medium.com/max/800/0*XeXvhTpBFXvYlcxF.jpeg)

### Toptal: Test with Stackoverflow solution

First, I applied to Toptal, a selective freelancing platform claiming to “hire” the top 3% of freelance talent. It means only 3% of applicants succeed at their entry test, opening access to their freelancing platform.

At Toptal, they are now “hiring” data scientists, although they don’t provide any information about the opportunities available on their platform (vs. competitors like Upwork and Freelancer.com, where anyone can see project offers):

![](https://cdn-images-1.medium.com/max/800/0*pR3iMVDTuBPvUix1.jpeg)

I applied, and after the HR interview, I was invited to take Codility tests. They consist of complex coding puzzles, with no relevance to data science whatsoever (a Datacamp test would make more sense). Codility is a branch of software engineering by itself, with little real-world applications beyond job interviews. Despite widespread criticism ([here](https://theoutline.com/post/1166/programmers-are-confessing-their-coding-sins-to-protest-a-broken-job-interview-process), and [here](https://www.qualified.io/blog/posts/why-developers-hate-coding-skills-tests)…), they are still used in the software industry.

![](https://cdn-images-1.medium.com/max/800/0*Sm0brBzR2ExY9dX2.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/0*HA8Q9I0oNjMOlatM.jpeg)
...
Then comes Sleepiz. It’s a spinoff from the prestigious ETH Zurich in Switzerland.

![](https://cdn-images-1.medium.com/max/800/1*ou9RnDMEV6n9INZxUiJkOA.jpeg)

Sleepiz is “[Europe’s most promising digital health startup](https://sleepiz.com/about/)”, building medical-grade sleep monitoring at home.
...
![](https://cdn-images-1.medium.com/max/800/0*q7bVvSTTnZ9ZWYFl.jpeg)
...
After some intensive googling, I was surprised to find out the exact task on Kaggle!

![](https://cdn-images-1.medium.com/max/800/0*Uvc-xhjMWcISiqkl.jpeg)

I immediately reported this unexpected discovery to the Sleepiz team, insisting that a senior ML engineer/researcher shouldn’t re-invent the wheel. However, it wasn’t enough for Sleepiz:

![](https://cdn-images-1.medium.com/max/800/0*oi1JcL99PRm06mQu.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/0*YT61ly-bcUW6zOav.jpeg)
...
I wanted this conversation to be productive, so I took the initiative to look at the recent publications of interviewers, to find out something inspiring. My attention was caught by their recent paper about Covid-19: “[Early risk assessment for COVID-19 patients from emergency department data using machine learning](https://www.medrxiv.org/content/10.1101/2020.05.19.20086488v1)”. Sensyne Health even brags about this paper on Twitter:

![](https://cdn-images-1.medium.com/max/800/0*vMjK3NEVCvufcGkF.jpeg)

I had a similar project within the [COVIND medical data consortium](https://covind.org) that I launched at the beginning of the pandemic. So I was baffled that their NHS data, which they also brag a lot about (“[one of the world’s largest and most valuable datasets](https://www.sensynehealth.com/discovery-nhs-trusts)”), didn’t even include patient comorbidities and previous conditions (like diabetes and asthma), which matter a lot in Covid-19, as everyone knows. As a result, their “risk assessment” is unsurprisingly trivial: the “age” feature dwarfs all the others:

![](https://cdn-images-1.medium.com/max/800/0*M_EjZAm0b9QQxThB.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/0*f6Wddv6ZqHw0XE4_.jpeg)
...
We are in the 21st century, with smartphones everywhere. I was surprised to find such weird interviews at tech startups, who are supposed to build the future (ETH Zurich motto is “Where the future begins”. How ironic). They remind me of the Algerian political regime, who cuts the internet every year for the baccalaureate national exam, in order to avoid leaks.
  ...
  <iframe  style="margin:0 auto;" src="https://www.youtube.com/embed/Tt7XbF-CQ50" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![](https://cdn-images-1.medium.com/max/800/0*Q8Jz5faQ3iIj7rNZ.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/0*m7cb54p3ENILhQqm.jpeg)

![](https://cdn-images-1.medium.com/max/800/1*SRMaD0th_XItR5UvUq6kCQ.jpeg)
...
This blog post is already pretty long, so I will present my alternative perspective on tech recruitment in the 21st century, a recruitment that embraces copy-pasting, in a follow-up blog post, if enough people ask (my Twitter [@mostafabenh](https://twitter.com/mostafabenh)). In fact, I am building my own startup team, in parallel with my job hunt.
