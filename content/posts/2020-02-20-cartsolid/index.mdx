---
title: CAR-T cells for solid cancers - Feed clinical data back for reducing risks
...
Cancer drug development is very risky. The pipeline suffers from a lot of attrition: [only 3.4% of human-tested oncology drugs](https://doi.org/10.1093/biostatistics/kxx069) reach the market. It means **96.6% fail**.

To reduce failure, one idea is to feed clinical data back into early drug development, **from bedside to bench.**
